...
import { Mail, Lock, Zap, AlertCircle, ArrowRight, Eye, EyeOff, X } from 'lucide-react';
    ...
    <div className="min-h-[calc(100dvh-4rem)] bg-[#050507] flex items-start md:items-center justify-center px-4 pt-8 pb-8 md:p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-6">
            <Link to="/" className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-500/30 bg-cyan-900/10 text-cyan-400 text-xs font-mono mb-3 hover:bg-cyan-900/20 transition-colors cursor-pointer">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
            <div className="space-y-1">
                ...
                <div className="relative">
                    <input 
                        ...
                        autoComplete="email"
                        className="w-full bg-[#0a0a0f] border border-white/10 rounded-xl py-2.5 pl-9 pr-4 text-white text-sm focus:border-cyan-500/50 focus:bg-cyan-900/5 transition-all outline-none peer"
            ...
            <div className="space-y-1">
                <div className="flex justify-between items-center ml-1">
                    ...
                    <Link to="/forgot-password" className="text-[12px] text-cyan-400 hover:text-cyan-300">¿Olvidaste tu contraseña?</Link>
                </div>
                <div className="relative">
                    <input 
                        ...
                        className="w-full bg-[#0a0a0f] border border-white/10 rounded-xl py-2.5 pl-9 pr-9 text-white text-sm focus:border-cyan-500/50 focus:bg-cyan-900/5 transition-all outline-none peer"
                        placeholder="••••••••"
                    />
        ...
        <p className="mt-6 text-center text-gray-500 text-xs">
            ¿No tenés cuenta? <Link to="/registro" className="text-cyan-400 text-[12px] font-bold hover:text-cyan-300 underline">Crear cuenta</Link>
        </p>
