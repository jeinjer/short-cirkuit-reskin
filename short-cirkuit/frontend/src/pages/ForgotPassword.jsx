...
import { AlertCircle, ArrowLeft, CheckCircle, Mail, Send, Zap } from 'lucide-react';
import AuthLayout from '../components/auth/AuthLayout';
import useForgotPasswordPageForm from '../hooks/auth/useForgotPasswordPageForm';

export default function ForgotPasswordPage() {
  const { register, errors, serverError, success, loading, onSubmit } = useForgotPasswordPageForm();
  ...
  return (
    <AuthLayout containerClassName="px-3 md:p-4" initialY={24}>
      ...
      <div className="mt-6 text-center">
        <Link
          to="/login"
          className="inline-flex items-center gap-2 text-xs font-bold text-gray-500 hover:text-white transition-colors uppercase tracking-wide"
        >
